...
<script setup lang="ts">
  ...
  const people = [
    {
      quote:
        'Bekerja sama dengan Hetari dalam berbagai proyek merupakan suatu kesenangan sejati. Keterampilannya yang luar biasa, perhatiannya terhadap detail, dan komitmennya terhadap kualitas secara konsisten menjadikannya aset yang sangat berharga bagi tim.',
    ...
    {
      quote:
        'Bekerja sama dengan Ebraheem dalam pembuatan situs web Axon merupakan pengalaman yang luar biasa. Dukungan dan dedikasinya yang tak ternilai sangat penting dalam mewujudkan proyek ini. Terima kasih, Ebraheem!',
      author: 'Esmail Atta',
