    ...
    >
      <div class="flex flex-col items-center text-center">
        ...
        <h2 class="mt-2 font-semibold text-gray-800">
         UI/UX mungkin berbeda <b>tergantung browser yang Anda gunakan</b>.
        </h2>
        <p class="mt-2 w-full text-start text-sm leading-relaxed text-gray-600">
          Beberapa fitur mungkin tidak berfungsi seperti yang diharapkan, terutama dalam mode gelap.
        ...
        <div class="flex-center">
          ...
          <i>Aktifkan 'Gunakan tema gelap situs web'</i>
        </div>

        <p class="mt-3 text-xl font-bold">Kemudian muat ulang halaman.</p>
      </div>
