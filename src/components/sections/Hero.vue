      ...
      <div class="relative flex w-full flex-col items-center">
        ...
        <div class="lg:column-gap spacing-t grid w-full grid-cols-12">
          ...
          >
            ...
            <p class="sr-only">
              Seorang pengembang full-stack lepas, menggunakan teknologi mutakhir untuk
              memberikan solusi komprehensif bagi bisnis Anda.
            </p>
            <p
              v-html="whoAmI"
              id="whoAmI"
            ...
            <div class="relative origin-left overflow-hidden sm:scale-150">
              <div id="contact-btn" class="flex -translate-y-full">
                <!-- <Button
                  ...
                  label="Get in touch"
                /> -->
                <Button label="Get in touch" url="https://wa.me/085860891301" />
              </div>
            </div>
          </div>
          ...
          >
            ...
            >
              ...
              >
                Tersedia untuk pekerjaan lepas.
              </p>
              <h3
...
<script setup lang="ts">
  ...
  const whoAmI = ref(
    'Seorang pengembang full-stack lepas, menggunakan teknologi mutakhir untuk memberikan solusi komprehensif bagi bisnis Anda.',
  );
