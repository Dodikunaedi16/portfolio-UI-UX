    ...
    >
      ...
      >
        ...
        <p class="heading-6 font-fancy w-full text-balance sm:max-w-[40ch]">
          Berikut testimoni klien saya tentang kolaborasi kami. Kepuasan mereka
          dan terpenuhinya harapan adalah prioritas utama saya, untuk memastikan pengalaman terbaik
          yang mungkin.
        </p>
      </div>
    </div>
