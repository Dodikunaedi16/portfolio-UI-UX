  ...
  >
    ...
    <div class="padding-y md:column-gap mt-6 grid grid-cols-12">
      ...
      <div class="col-span-11 mt-10 md:col-span-8 md:col-start-6">
        ...
        >
          Dengan semangat yang tinggi terhadap desain dan pengembangan, 
          saya menangani proyek dari tahap ideasi hingga peluncuran, 
          memastikan perjalanan yang lancar dan memberikan dampak positif yang berkelanjutan pada lanskap digital dan bisnis Anda.
        </p>
        ...
        >
          ...
          <p class="heading-6 font-fancy w-full text-balance sm:max-w-[40ch]">
           Menciptakan pengalaman web yang hebat adalah fokus utama saya. 
           Saya memastikan setiap proyek memberikan kesan positif kepada 
           pengguna melalui perhatian yang cermat terhadap detail dan prinsip 
           desain yang berpusat pada pengguna. <br /><br />
           Saat saya tidak sedang sibuk dengan pengembangan dan desain web, Anda dapat menemukan saya di sini.
            berbagi wawasan tentang perjalanan saya sebagai pekerja lepas di <i>&Xopf;</i>,
           dengan keras, memainkan musik (Funk), atau sekadar bersantai.
          </p>
        </div>
      </div>
    </div>
...
<script setup lang="ts">
  ...
  onBeforeMount(() => {
    aboutMe.value = textSplitterIntoChar(
      'Programmer, Developer, UI/UX Designer.',
      true,
      true,
    );
  });
