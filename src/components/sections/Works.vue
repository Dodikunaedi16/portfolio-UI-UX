  ...
  <section id="works" class="common-padding mb-20">
    <div class="flex flex-col">
      ...
      >
        ...
        >
          Proyek-proyek klien unggulan yang telah dirancang dengan cermat dengan
          semangat dan tujuan selama bertahun-tahun.
        </p>
      </div>
    </div>
  ...
  const selectedWorksProps = [
    {
      ...
      videoSrc: work5,
      imageBg: workBg5,
      url: 'https://snackbeyond.vercel.app/',
      year: '2025',
    },
    {
      ...
      videoSrc: work2,
      imageBg: workBg2,
      url: 'https://github.com/Dodikunaedi16/iPhone15-pro-clone-main',
      year: '2024',
    },
    {
      name: 'Axon',
      ...
      videoSrc: work3,
      imageBg: workBg3,
      url: 'https://github.com/Dodikunaedi16/Axon-llama-clean',
    ...
    },
    {
      ...
      videoSrc: work4,
      imageBg: workBg4,
      url: 'https://github.com/Dodikunaedi16/Masdod_blog',
      year: '2023',
    },
    {
      name: 'Pyutube',
      ...
      videoSrc: work1,
      imageBg: workBg1,
      url: 'https://github.com/Dodikunaedi16/pyutube',
      year: '2024',
    },
  ];
