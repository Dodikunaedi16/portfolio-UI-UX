  ...
  >
    ...
    >
      ...
      <div class="flex-center z-10 flex-col gap-y-10">
        ...
        >
          Desain Anda adalah sebuah mahakarya yang menunggu untuk diwujudkan.
        </p>
        <h3
          id="make-it-happen"
      ...
      >
        ...
        <div class="heading-6 text-flax-smoke-500 w-fit">
          <p class="w-full font-bold uppercase">Untuk pertanyaan lebih lanjut</p>
          <Link
            class="text-flax-smoke-300 h-6 text-right font-medium tracking-wider lowercase"
            label="dodikunaedi381@gmail.com"
            :icon="true"
            url="mailto:dodikunaedi381@gmail.com"
          />
        </div>
      </div>
    </div>
