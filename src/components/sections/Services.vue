  ...
  <section id="services" class="padding-x mb-20">
    <div class="flex w-full flex-col">
      ...
      >
        ...
        >
          Antarmuka yang ramah pengguna tidak terjadi secara kebetulan, melainkan dibangun dengan sengaja.

          Saya membuat kode solusi responsif intuitif yang membuat perjalanan pengguna Anda menjadi mudah.
        </p>
      </div>
    </div>
...
<script setup lang="ts">
  ...
  const servicesCardProps = [
    {
      ...
      body: 'Saya membuat situs web yang dikembangkan secara khusus untuk merek Anda. Saya fokus memastikan situs web tersebut dapat diskalakan, cepat, mudah diakses, dan memiliki animasi yang menarik untuk memberikan pengalaman yang tak terlupakan bagi pengguna.',
  ...
  `,
    },
    {
      ...
      body: 'Saya berspesialisasi dalam mengembangkan aplikasi web canggih yang mendefinisikan ulang kemungkinan platform online, merancang aplikasi web progresif, dan mengintegrasikan sistem yang kompleks.',
      headings: [
  ...
  `,
    },
    {
      ...
      body: 'Saya mengoptimalkan kinerja situs web Anda dengan menerapkan praktik terbaik dalam pengoptimalan kecepatan, desain responsif, dan penggunaan framework modern untuk memastikan pengalaman pengguna yang mulus di berbagai perangkat.',
      headings: [
        'Modern Frameworks',
        'Responsive Design',
        'Speed Optimization',
